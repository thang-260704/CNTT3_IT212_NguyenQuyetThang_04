...
# 2. PHẦN 1 - Tái cấu trúc hệ thống để dễ mở rộng
...
## 2.5. Vì sao giải pháp dễ mở rộng
...
# 3. PHẦN 2 - Debugging bảo mật và xử lý lỗi hệ thống
...
## 3.4. Vì sao không nên chỉ try-catch trong Filter
...
# 4. PHẦN 3 - Phân tích và thiết kế Rikkei LMS với AI

## 4.1. Nhiệm vụ 1: Đề xuất Tech Stack
...
## 4.2. Nhiệm vụ 2: Entity Analysis
...
# 5. Phân tích lỗi AI và cách khắc phục

## 5.1. Lỗi AI ở lần sinh code đầu tiên
...
## 5.2. Cách khắc phục bằng prompt lặp
